...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    property var can_suspend: ["Suspend", config.TranslateSuspend || textConstants.suspend, sddm.canSuspend]
    property var can_hibernate: ["Hibernate", config.TranslateHibernate || textConstants.hibernate, sddm.canHibernate]
    ...
    function loadBottomButtons() {
        ...
        if (component.status == Component.Ready) {
            ...
            if (can_hibernate) {
                ...
                btn.buttontype = "left";
                // set button label
                btn.buttonlabel = textConstants.hibernate
            ...
            if (can_suspend) {
                ...
                btn.buttontype = "left";
                // set button label
                btn.buttonlabel = textConstants.suspend
                // set the function for button action on mouse click
