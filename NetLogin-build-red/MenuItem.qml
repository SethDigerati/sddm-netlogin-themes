...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    readonly property color hover_label_color: "#ff6a6a"
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function handleEntered() {
        ...
        // start marquee if text is long enough
        if (menu_item_label.length > 30)
            marqueeAnim.start();
    }
    ...
    function handleExited() {
        ...
        // stop marquee and reset position
        marqueeAnim.stop();
        label.x = 0;
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // menu item label (marquee for long text)
    Rectangle {
        id: labelFrame
        color: "transparent"
        width: Math.min(label.implicitWidth + 2, Math.round(label.font.pixelSize * 0.62 * 30))
    ...
    SequentialAnimation {
        ...
        NumberAnimation {
            ...
            from: 0; to: labelFrame.width - label.implicitWidth
            duration: Math.max(1000, (label.implicitWidth - labelFrame.width) * 15)
            easing.type: Easing.Linear
        }
        PauseAnimation { duration: 2000 }
        NumberAnimation {
            target: label; property: "x"
            from: labelFrame.width - label.implicitWidth; to: 0
            duration: Math.max(1000, (label.implicitWidth - labelFrame.width) * 15)
            easing.type: Easing.Linear
        }
    }
