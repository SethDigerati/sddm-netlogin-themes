...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // when pin mode toggles, update label if in password/PIN section
    onPinModeChanged: {
        if (password.visible)
            textboxlabel.state = pinMode ? "showpinlabel" : "showpasswordlabel";
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // appendChar: appends a character to the active input field
    ...
    // deleteChar: removes the last character from the active input field
    function deleteChar() {
        if (name.visible && name.focus) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Text {
        ...
        states: [
            ...
            // this state shows the "PIN" label
            State {
                name: "showpinlabel"
                PropertyChanges {
                    target: textboxlabel
    ...
    Item {
        ...
        TextInputBox {
            ...
            Keys.onPressed: event => {
                ...
                // when CapsLock key is pressed
                } else if (event.key === Qt.Key_CapsLock) {
                    loginroot.capsLock = !loginroot.capsLock;
                    event.accepted = true;
        ...
        Image {
            ...
            width: 28
            height: 28
            source: Qt.resolvedUrl("images/password_icon.png")
        ...
        PasswordInputBox {
            ...
            imageFadeOut: 0
            imageFadeIn: 0
            image: Qt.resolvedUrl("images/warning.png")
        ...
        // pin mode toggle icon
        Image {
            id: pinIcon
            width: 30
            height: 30

            // hide when in username section
            visible: password.visible

            // place it after the textbox with a gap
            anchors.left: textbox.right
            anchors.leftMargin: 10
            anchors.verticalCenter: textbox.verticalCenter

            source: pinMode ? "icons/key.png" : "icons/padlock.png"
